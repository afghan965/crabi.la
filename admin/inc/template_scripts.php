...
<script src="http://crabi.la/admin/js/vendor/bootstrap.min.js"></script>
<script src="http://crabi.la/admin/js/plugins.js"></script>
<script src="http://crabi.la/admin/js/app.js"></script>
